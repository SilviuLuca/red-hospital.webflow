<?php include 'includes/db.php'; ?>
 ...
 <?php
        ...
        if (isset($_GET['blog'])) {
            ...
            $tarife_id = $_GET['blog'];
            $query = "SELECT * FROM tarife WHERE id = {$tarife_id} ";
            $select_tarife = mysqli_query ($connection,$query);

        }

        while ($row = mysqli_fetch_assoc($select_tarife)) {

            $tarife_interogat_titlu = $row['titlu'];
            $tarife_interogat_categorie = $row['categorie'];
            $tarife_interogat_imagine = $row['imagine'];
            $tarife_interogat_tags = $row['tags'];
            $tarife_interogat_date = $row['date'];
            $tarife_interogat_continut = $row['continut'];
            $tarife_interogat_id = $row['id'];
...
<head>
  ...
  <script>
    ...
    <meta property="og:image" content="http://recumedis.ro/images/blog/<?php echo $tarife_interogat_imagine; ?>" />
    <meta property="og:title" content="RedHospital - Tarife" >
  <meta charset="utf-8">
  <title><?php echo $tarife_interogat_titlu; ?></title>
...
<body class="body-11">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div><a href="tarife.php" class="link-bread">Tarife</a>
      <div class="text-block-23"> &gt;</div><a href="tarife-detaliat.php?blog=<?php echo $tarife_interogat_id; ?>" class="link-bread"><?php echo $tarife_interogat_titlu; ?></a></div>
  </div>
  <div class="spitale-informatii-generale">
    <div class="w-container">
      <h3 class="heading-3"><strong>Tarife</strong></h3>
    </div>
  </div>
  ...
  <div class="section-6">
    <div class="w-container">
        ...
        <div class="div-block-9 all-blog-text">
          <h4><?php echo $tarife_interogat_titlu; ?></h4>
          <div class="text-block-39">
              Postat: <span class="text-span-3"><?php echo $tarife_interogat_date; ?></span> -
              Autor: <span class="text-span-2">Recumedis</span> -
              Categoria: <span class="text-span"><?php echo $tarife_interogat_categorie; ?></span>
            </div>

          <div class="text-block-40">


              <div class="imagine-left"><img src="images/blog/<?php echo $tarife_interogat_imagine; ?>" alt="" width="320px"></div>
              <div class="text-blog-right"><p><?php echo $tarife_interogat_continut; ?></p>

              <div class="fb-share-button" data-href="http://www.recumedis.ro/tarife-detaliat.php?blog=<?php echo $tarife_id; ?>" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
