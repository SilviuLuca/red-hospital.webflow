...
<html data-wf-page="5dded1d9214fad672488c9df" data-wf-site="5ddba24dd31f0f85cd6cc289">
<head>
  ...
  <meta charset="utf-8">
  <title>spitale-kinetoterapie</title>
  <meta content="spitale-kinetoterapie" property="og:title">
...
<body>
  ...
  <div class="spitale-informatii-generale">
    <div class="w-container">
      <h3 class="heading-3"><strong>Kinetoterapie</strong></h3>
    </div>
  </div>
  <div class="section-6">
    <div class="w-container">
      <div class="w-row">
        ...
        <div class="column-3 w-col w-col-9">
          <h1 class="heading-11"><strong>Kinetoterapie</strong></h1>
          <div class="text-block-31"><strong>Kinetoterapia, </strong>cunoscută și sub denumirea de terapie prin mișcare, are drept scop refacerea unor funcții ale organismului diminuate din cauza unor boli sau traumatisme. Acest tip de terapie este indicat atât în tratarea afecțiunilor locomotorii, însă și în tratarea anumitor boli metabolice, cardiovasculare, respiratorii sau chiar a unor afecțiuni ale organelor interne. Kinetoterapia include numeroase proceduri și exerciții, iar pentru fiecare pacient în parte este alcătuit un program adecvat afecțiunilor de care acesta suferă, ulterior stabilirii diagnosticului. Kinetoterapia este indicată în afecțiuni precum:<br> - Malformații congenitale;<br> - Afecțiuni reumatismale: artroză, spondilită, periartrită, coxartroză,gonartroză;<br> - Afecțiuni musculare;<br>- Afecțiuni neurologice: monoplegii, pareze, neuropatie, post accidente vasculare cerebrale (AVC), boli degenerative si inflamatorii ale sistemului nervos;<br> - Deviații ale coloanei vertebrale: cifoza; scolioza;<br> - Afecțiuni respiratorii;<br> - Afecțiuni cardiovasculare (cardiopatie ischemicǎ, sindromul de ischemie perifericǎ progresivǎ cronicǎ, boala varicoasǎ);<br> - Tulburări metabolice.</div>
        </div>
      </div>
    </div>
  </div>
