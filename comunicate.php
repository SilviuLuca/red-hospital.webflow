...
<head>
  ...
  <meta content="comunicate de presa" property="og:title">
...
<body class="body-13">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div>
        <a href="http://www.recumedis.ro/comunicate.php" class="link-bread"> <?php echo $comunicate_titlu; ?> </a></div>
  </div>
  ...
  <div>
    <div class="w-container">
      <h3 class="heading-16"><?php echo $comunicate_titlu; ?></h3>
    </div>
  </div>
  <div class="section-8">
