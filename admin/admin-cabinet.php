        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $select_all_cabinet = mysqli_query($connection,$query);
                            
                                
                                while ($row = mysqli_fetch_assoc($select_all_cabinet)) {
                             ...
                             <tr>
                                <td><?php echo $cabinet_titlu; ?></td>
                                <td><?php echo$cabinet_categorie; ?></td>
                                <td><a href="admin-cabinet-delete.php?delete=<?php echo $cabinet_id ?>" class="btn btn-danger" onclick="return confirm('Sigur vrei sa stergi?')">Stergere</a></td>
                                 <td><a href="admin-cabinet-edit.php?update=<?php echo $cabinet_id ?>" class="btn btn-success">Modifica</a></td>
                             </tr>
                    ...
                    <div class="col-md-12">
                        <h2>Adauga textul</h2>
                        <form action="admin-cabinet-adauga.php" method="post" enctype="multipart/form-data">
