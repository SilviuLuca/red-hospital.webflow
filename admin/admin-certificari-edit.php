                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Editeaza pagina cu certificari
                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_certificari_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM certificari WHERE id = {$update_certificari_id} ";
                           ...
                           if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE certificari SET categorie='$categorie', titlu='$titlu', continut='$continut' WHERE id = '$update_$certificari_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "admin-certificari.php";
                            </script>    
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $certificari_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $certificari_titlu; ?>" name="titlu" id="titlu">

                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="editor" class="ckeditor"  name="content"><?php echo $certificari_continut; ?>
