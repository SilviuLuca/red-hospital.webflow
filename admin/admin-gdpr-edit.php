                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_gdpr_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM gdpr WHERE id = {$update_gdpr_id} ";
                            $update_query = mysqli_query($connection, $query);

                            while ($row = mysqli_fetch_assoc($update_query)) {
                                    $gdpr_categorie = $row['categorie'];
                                    $gdpr_titlu = $row['titlu'];
                                    $gdpr_id = $row['id'];                               
                                    $gdpr_continut = $row['continut'];
                           ...
                           if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE gdpr SET categorie='$categorie', titlu='$titlu', continut='$continut' WHERE id = '$update_gdpr_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "admin-gdpr.php";
                            </script>    
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $gdpr_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $gdpr_titlu; ?>" name="titlu" id="titlu">

                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="summernote"  name="content"><?php echo $gdpr_continut; ?>
