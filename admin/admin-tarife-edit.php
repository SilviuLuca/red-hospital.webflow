                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_tarife_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM tarife WHERE id = {$update_tarife_id} ";
                           ...
                           if (isset($_POST['submit'])) {
                               ...
                               if(empty($imagine)) {
                                ...
                                $sql = "UPDATE tarife SET categorie='$categorie', titlu='$titlu', imagine='$imagine', continut='$continut', tags='$tags' WHERE id = '$update_tarife_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "admin-tarife.php";
                            </script>    
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $tarife_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $tarife_titlu; ?>" name="titlu" id="titlu">
                          
                             
                               
                            <label for="imagine">Imagine: (ATENTIE: maxim 2mb)</label>
                            <img width="100" src="../images/blog/<?php echo $tarife_fotografie; ?>" alt="">
                            <input type="file" name="imagine" id="imagine">
                            
                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="editor"  class="ckeditor" name="content"><?php echo $tarife_continut; ?>
                                    
                            </textarea>
                               
                            <label for="nume">Taguri: </label>
                            <input type="text" value = "<?php echo $tarife_tags; ?>" name="tags" id="tags">
