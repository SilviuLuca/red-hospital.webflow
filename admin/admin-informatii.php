        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $select_all_informatii = mysqli_query($connection,$query);
                            
                                
                                while ($row = mysqli_fetch_assoc($select_all_informatii)) {
                             ...
                             <tr>
                                <td><?php echo $info_titlu; ?></td>
                                <td><?php echo $info_categorie; ?></td>
                                <td><a href="admin-informatii-delete.php?delete=<?php echo $info_id ?>" class="btn btn-danger" onclick="return confirm('Sigur vrei sa stergi?')">Stergere</a></td>
                                 <td><a href="admin-informatii-edit.php?update=<?php echo $info_id ?>" class="btn btn-success">Modifica</a></td>
                             </tr>
                    ...
                    <div class="col-md-12">
                        <h2>Adauga textul</h2>
                        <form action="admin-informatii-adauga.php" method="post" enctype="multipart/form-data">
