                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_blog_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM blog WHERE id = {$update_blog_id} ";
                            $update_query = mysqli_query($connection, $query);

                            while ($row = mysqli_fetch_assoc($update_query)) {
                                    $blog_categorie = $row['categorie'];
                                    $blog_titlu = $row['titlu'];
                                    $blog_fotografie = $row['imagine'];
                                    $blog_id = $row['id'];                               
                           ...
                           if (isset($_POST['submit'])) {
                               ...
                               if(empty($imagine)) {
                                ...
                                $sql = "UPDATE blog SET categorie='$categorie', titlu='$titlu', imagine='$imagine', continut='$continut', tags='$tags' WHERE id = '$update_blog_id'";
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $blog_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $blog_titlu; ?>" name="titlu" id="titlu">
                          
                             
                               
                            <label for="imagine">Imagine: (ATENTIE: maxim 2mb)</label>
                            <img width="100" src="../images/blog/<?php echo $blog_fotografie; ?>" alt="">
                            <input type="file" name="imagine" id="imagine">
                            
                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="editor"  class="ckeditor" name="content"><?php echo $blog_continut; ?>
                                    
                            </textarea>
                               
                            <label for="nume">Taguri: </label>
                            <input type="text" value = "<?php echo $blog_tags; ?>" name="tags" id="tags">
