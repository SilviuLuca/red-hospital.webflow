        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                             ...
                             <tr>
                                <td><?php echo $cod_titlu; ?></td>
                                <td><?php echo $cod_categorie; ?></td>
                                <td><a href="admin-codetica-delete.php?delete=<?php echo $cod_id ?>" class="btn btn-danger" onclick="return confirm('Sigur vrei sa stergi?')">Stergere</a></td>
                                 <td><a href="admin-codetica-edit.php?update=<?php echo $cod_id ?>" class="btn btn-success">Modifica</a></td>
                             </tr>
                    ...
                    <div class="col-md-12">
                        <h2>Adauga textul</h2>
                        <form action="admin-cod-adauga.php" method="post" enctype="multipart/form-data">
