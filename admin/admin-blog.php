            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                             ...
                             <tr>
                                <td><?php echo $blog_titlu; ?></td>
                                <td><?php echo $blog_categorie; ?></td>
                                <td><img src="../images/blog/<?php echo $blog_fotografie; ?>" style="max-width:50px"></td>
                                <td><a href="admin-blog-delete.php?delete=<?php echo $blog_id ?>" class="btn btn-danger" onclick="return confirm('Sigur vrei sa stergi?')">Stergere</a></td>
                                 <td><a href="admin-blog-edit.php?update=<?php echo $blog_id ?>" class="btn btn-success">Modifica</a></td>
                             </tr>
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="admin-blog-adauga.php" method="post" enctype="multipart/form-data">
