                       ...
                       <div class="col-md-12">
                        ...
                        <?php
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_cod_id = $_GET['update'];

                            }

                            $query = "SELECT * FROM codetica WHERE id = {$update_cod_id} ";
                            $update_query = mysqli_query($connection, $query);

                            while ($row = mysqli_fetch_assoc($update_query)) {
                                    $cod_categorie = $row['categorie'];
                                    $cod_titlu = $row['titlu'];
                                    $cod_id = $row['id'];
                                    $cod_continut = $row['continut'];
                           ...
                           if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE codetica SET categorie='$categorie', titlu='$titlu', continut='$continut' WHERE id = '$update_cod_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "admin-codetica.php";
                            </script>
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $cod_categorie; ?>" >

                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $cod_titlu; ?>" name="titlu" id="titlu">

                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="summernote"  name="content"><?php echo $cod_continut; ?>
