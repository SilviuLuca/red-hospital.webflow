                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Editeaza informatiile generale
                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_informatii_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM informatii WHERE id = {$update_informatii_id} ";
                           ...
                           if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE informatii SET categorie='$categorie', titlu='$titlu', continut='$continut' WHERE id = '$update_informatii_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "admin-informatii.php";
                            </script>    
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $info_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $info_titlu; ?>" name="titlu" id="titlu">

                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="summernote"  name="content"><?php echo $info_continut; ?>
