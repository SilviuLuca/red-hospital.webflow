                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_grup_id = $_GET['update'];

                            }

                            $query = "SELECT * FROM grupuliasisting WHERE id = {$update_grup_id} ";
                           ...
                           if (isset($_POST['submit'])) {
                               ...
                               if(empty($imagine)) {
                                ...
                                $sql = "UPDATE grupuliasisting SET titlu='$name', imagine='$imagine', continut='$continut' WHERE id = '$update_grup_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "grupul-iasisting.php";
                            </script>    
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" value = "<?php echo $grup_titlu; ?>" name="titlu" id="titlu">
                          
                             
                               
                            <label for="imagine">Imagine: (ATENTIE: maxim 2mb)</label>
                            <img width="100" src="../images/grupul/<?php echo $grup_fotografie; ?>" alt="">
                            <input type="file" name="imagine" id="imagine">
                            
                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="editor"  class="ckeditor" name="content"><?php echo $grup_continut; ?>
