                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_angajari_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM angajari WHERE id = {$update_angajari_id} ";
                            ...
                            while ($row = mysqli_fetch_assoc($update_query)) {
                                    ...
                                    $angajari_id = $row['id'];                               
                                    $angajari_continut = $row['continut'];
                           ...
                           if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE angajari SET categorie='$categorie', titlu='$titlu', continut='$continut' WHERE id = '$update_angajari_id'";
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                window.location = "admin-angajari.php";
                            </script>    
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $angajari_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $angajari_titlu; ?>" name="titlu" id="titlu">

                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="summernote"  name="content"><?php echo $angajari_continut; ?>
