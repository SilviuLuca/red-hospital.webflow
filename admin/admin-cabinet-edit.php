                       ...
                       <div class="col-md-12">
                        ...
                        <?php 
                           ...
                           if (isset($_GET['update'])) {
                                ...
                                $update_cabinet_id = $_GET['update'];
                               
                            }

                            $query = "SELECT * FROM cabinet WHERE id = {$update_cabinet_id} ";
                           ...
                           if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE cabinet SET categorie='$categorie', titlu='$titlu', continut='$continut' WHERE id = '$update_cabinet_id'";
                        ...
                        ?>
                           ...
                           <form action="" method="POST" onSubmit="window.location.reload()" enctype="multipart/form-data">
                            ...
                            <input type="text" id="categorie" name="categorie" value = "<?php echo $cabinet_categorie; ?>" >
                            
                            <label for="nume">Titlu: </label>
                            <input type="text" value = "<?php echo $cabinet_titlu; ?>" name="titlu" id="titlu">

                            <label for="editor">Continut: </label>
                            <textarea cols="100" rows="12"  id="summernote"  name="content"><?php echo $cabinet_continut; ?>
