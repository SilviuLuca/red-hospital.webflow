            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                             ...
                             <tr>
                                <td><?php echo $covid_titlu; ?></td>
                                <td><?php echo $covid_categorie; ?></td>
                                <td><img src="../images/covid/<?php echo $covid_fotografie; ?>" style="max-width:50px"></td>
                                <td><a href="admin-covid-delete.php?delete=<?php echo $covid_id ?>" class="btn btn-danger" onclick="return confirm('Sigur vrei sa stergi?')">Stergere</a></td>
                                 <td><a href="admin-covid-edit.php?update=<?php echo $covid_id ?>" class="btn btn-success">Modifica</a></td>
                             </tr>
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="admin-covid-adauga.php" method="post" enctype="multipart/form-data">
