        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h2>Mail</h2>
                        <form action="newsletter_send.php" method="post" enctype="multipart/form-data">
                            ...
                            <select name="to_email" id="to_email" required>
                                ...
                                <option value="colegi">---Doar colegii iasisting---</option>
                                <option value="utilizatori">---Doar utilizatorii---</option>
