        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                                ...
                                $select_all_sfsava = mysqli_query($connection,$query);
                            
                                
                                while ($row = mysqli_fetch_assoc($select_all_sfsava)) {
                             ...
                             <tr>
                                <td><?php echo $sfsava_titlu; ?></td>
                                <td><?php echo $sfsava_categorie; ?></td>
                                <td><a href="admin-sfsava-delete.php?delete=<?php echo $sfsava_id ?>" class="btn btn-danger" onclick="return confirm('Sigur vrei sa stergi?')">Stergere</a></td>
                                 <td><a href="admin-sfsava-edit.php?update=<?php echo $sfsava_id ?>" class="btn btn-success">Modifica</a></td>
                             </tr>
                    ...
                    <div class="col-md-12">
                        <h2>Adauga textul</h2>
                        <form action="admin-sfsava-adauga.php" method="post" enctype="multipart/form-data">
