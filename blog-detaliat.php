<?php include 'includes/db.php'; ?>
 ...
 <?php
        ...
        while ($row = mysqli_fetch_assoc($select_blog)) {
            ...
            $blog_interogat_titlu = $row['titlu'];
            $blog_interogat_categorie = $row['categorie'];
            $blog_interogat_imagine = $row['imagine'];
            $blog_interogat_tags = $row['tags'];
            $blog_interogat_date = $row['date'];
            $blog_interogat_continut = $row['continut'];
            $blog_interogat_id = $row['id'];
...
<head>
  ...
  <script>
    ...
    <meta property="og:image" content="http://recumedis.ro/images/blog/<?php echo $blog_interogat_imagine; ?>" />
    <meta property="og:title" content="RedHospital - Blog" >
  <meta charset="utf-8">
  <title><?php echo $blog_interogat_titlu; ?></title>
...
<body class="body-11">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div><a href="blog.php" class="link-bread">Blog</a>
      <div class="text-block-23"> &gt;</div><a href="blog-detaliat.php?blog=<?php echo $blog_interogat_id; ?>" class="link-bread"><?php echo $blog_interogat_titlu; ?></a></div>
  </div>
  ...
  <div class="section-6">
    <div class="w-container">
        ...
        <div class="div-block-9 all-blog-text">
          <h4><?php echo $blog_interogat_titlu; ?></h4>
          <div class="text-block-39">
              Postat: <span class="text-span-3"><?php echo $blog_interogat_date; ?></span> -
              Autor: <span class="text-span-2">Recumedis</span> -
              Categoria: <span class="text-span"><?php echo $blog_interogat_categorie; ?></span>
            </div>

          <div class="text-block-40">


              <div class="imagine-left"><img src="images/blog/<?php echo $blog_interogat_imagine; ?>" alt="" width="320px"></div>
              <div class="text-blog-right"><p><?php echo $blog_interogat_continut; ?></p>

              <div class="fb-share-button" data-href="http://www.recumedis.ro/blog-detaliat.php?blog=<?php echo $blog_id; ?>" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
