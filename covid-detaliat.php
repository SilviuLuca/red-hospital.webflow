<?php include 'includes/db.php'; ?>
 ...
 <?php
        ...
        if (isset($_GET['covid'])) {
            ...
            $covid_id = $_GET['covid'];
            $query = "SELECT * FROM covid WHERE id = {$covid_id} ";
            $select_covid = mysqli_query ($connection,$query);

        }

        while ($row = mysqli_fetch_assoc($select_covid)) {

            $covid_interogat_titlu = $row['titlu'];
            $covid_interogat_categorie = $row['categorie'];
            $covid_interogat_imagine = $row['imagine'];
            $covid_interogat_tags = $row['tags'];
            $covid_interogat_date = $row['date'];
            $covid_interogat_continut = $row['continut'];
            $covid_interogat_id = $row['id'];
...
<head>
  ...
  <script>
    ...
    <meta property="og:image" content="http://recumedis.ro/images/covid/<?php echo $covid_interogat_imagine; ?>" />
    <meta property="og:title" content="RedHospital - Covid" >
  <meta charset="utf-8">
  <title><?php echo $covid_interogat_titlu; ?></title>
...
<body class="body-11">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div><a href="covid.php" class="link-bread">Covid-19</a>
      <div class="text-block-23"> &gt;</div><a href="covid-detaliat.php?blog=<?php echo $covid_interogat_id; ?>" class="link-bread"><?php echo $covid_interogat_titlu; ?></a></div>
  </div>
  ...
  <div class="section-6">
    <div class="w-container">
        ...
        <div class="div-block-9 all-blog-text">
          <h4><?php echo $covid_interogat_titlu; ?></h4>
          <div class="text-block-39">
              Postat: <span class="text-span-3"><?php echo $covid_interogat_date; ?></span> -
              Autor: <span class="text-span-2">Recumedis</span> -
              Categoria: <span class="text-span"><?php echo $covid_interogat_categorie; ?></span>
            </div>

          <div class="text-block-40">


              <div class="imagine-left"><img src="images/covid/<?php echo $covid_interogat_imagine; ?>" alt="" width="320px"></div>
              <div class="text-blog-right"><p><?php echo $covid_interogat_continut; ?></p>

              <div class="fb-share-button" data-href="http://www.recumedis.ro/covid-detaliat.php?covid=<?php echo $covid_id; ?>" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
