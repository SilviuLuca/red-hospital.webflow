...
<body class="body-14">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div><a href="angajari.php" class="link-bread"><?php echo $angajari_titlu; ?></a></div>
  </div>
  <div>
    <div class="w-container">
      <h3 class="heading-17"><?php echo $angajari_titlu; ?></h3>
    </div>
  </div>
  <div class="section-9">
    <div class="w-container">
