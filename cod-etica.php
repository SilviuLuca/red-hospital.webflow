...
<head>
  ...
  <meta charset="utf-8">
  <title>Cod Etica Conduita</title>
...
<body class="body-13">
    ...
    <?php
            ...
            $update_query = mysqli_query($connection, $query);
                while ($row = mysqli_fetch_assoc($update_query)) {
                    $codetica_categorie = $row['categorie'];
                    $codetica_titlu = $row['titlu'];
                    $codetica_id = $row['id'];
                    $codetica_continut = $row['continut'];
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div>
        <a href="http://www.recumedis.ro/cod-etica.php" class="link-bread"> <?php echo $codetica_titlu; ?> </a></div>
  </div>
  ...
  <div>
    <div class="w-container">
      <h3 class="heading-16"><?php echo $codetica_titlu; ?></h3>
    </div>
  </div>
  <div class="section-8">
