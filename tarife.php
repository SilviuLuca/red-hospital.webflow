...
<head>
  ...
  <meta charset="utf-8">
  <title>RedHospital - Tarife</title>
...
<body class="body-11">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-22">Te afli aici: </div><a href="www.recumedis.ro" class="link-bread">Acasa</a>
      <div class="text-block-23"> &gt;</div><a href="tarife.php" class="link-bread">Tarife</a></div>
  </div>
  <div class="spitale-informatii-generale">
    ...
    <?php
            ...
            $query = "SELECT * FROM tarife ORDER BY `date` DESC";
            ...
            while ($row = mysqli_fetch_assoc($select_all_tarife)) {
                ...
                $tarife_imagine = $row['imagine'];
                $tarife_id = $row['id'];
                $tarife_date = $row['date'];
                $tarife_continut = $row['continut'];
  ...
  <div class="section-6">
    <div class="w-container">
      <div class="articol-sfaturi-blog">
          <a href="tarife-detaliat.php?blog=<?php echo $tarife_id; ?>" class="link-block-4 w-inline-block">
              <img src="images/blog/<?php echo $tarife_imagine; ?>" alt="">
          </a>

        <div class="div-block-9">
          <h4><?php echo $tarife_titlu; ?></h4>
          <div class="text-block-39">
              Postat: <span class="text-span-3"><?php echo $tarife_date; ?></span> -
              Autor: <span class="text-span-2">Recumedis</span> -
              Categoria: <span class="text-span"><?php echo $tarife_categorie; ?></span>
            </div>

          <div class="text-block-40">

            <p><?php echo strip_tags(substr($tarife_continut, 0, 500)) . "..."; ?></p>

          </div>

            <a href="tarife-detaliat.php?blog=<?php echo $tarife_id; ?>" class="link-5">Mai multe...</a>
          </div>
      </div>
    </div>
  </div>
