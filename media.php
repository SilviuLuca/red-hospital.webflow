...
<body class="body-11">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div><a href="media.php" class="link-bread">Media</a></div>
  </div>
  <div class="spitale-informatii-generale">
    <div class="w-container">
      <h3 class="heading-3"><strong>Media</strong></h3>
    </div>
  </div>
    ...
    <?php
            ...
            $query = "SELECT * FROM sfaturi ORDER BY `date` DESC";
            $select_all_sfaturi = mysqli_query ($connection,$query);

            while ($row = mysqli_fetch_assoc($select_all_sfaturi)) {
                $sfaturi_titlu = $row['titlu'];
                $sfaturi_categorie = $row['categorie'];
                $sfaturi_imagine = $row['imagine'];
                $sfaturi_id = $row['id'];
                $sfaturi_date = $row['date'];
  ...
  <div class="section-6">
    <div class="w-container">
      <div class="articol-sfaturi-blog">
          <a href="media-detaliat.php?blog=<?php echo $sfaturi_id; ?>" class="link-block-4 w-inline-block">
              <img src="images/blog/<?php echo $sfaturi_imagine; ?>" alt="">
          </a>
        ...
        <div class="div-block-9">
          ...
          <div class="text-block-39">
              ...
              Categoria: <span class="text-span"><?php echo $sfaturi_categorie; ?></span>
            </div>

          <div class="text-block-40">

            <p><?php echo strip_tags(substr($sfaturi_continut, 0, 500)) . "..."; ?></p>

          </div>

            <a href="media-detaliat.php?blog=<?php echo $sfaturi_id; ?>" class="link-5">Mai multe...</a>
          </div>
      </div>
    </div>
  </div>
