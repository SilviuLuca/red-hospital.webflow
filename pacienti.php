...
<head>
  ...
  <meta charset="utf-8">
  <title>RedHospital - Pacienti</title>
  <meta content="Informatii Pacienti" property="og:title">
...
<body class="body-11">
  ...
  <div class="breadcrumb">
    <div class="container-8 w-container">
      ...
      <div class="text-block-23"> &gt;</div><a href="pacienti.php" class="link-bread">Pacienti</a></div>
  </div>
  <div class="spitale-informatii-generale">
    ...
    <?php
            ...
            $query = "SELECT * FROM pacienti ORDER BY `date` DESC";
            $select_all_pacienti = mysqli_query ($connection,$query);

            while ($row = mysqli_fetch_assoc($select_all_pacienti)) {
                $pacienti_titlu = $row['titlu'];
                $pacienti_categorie = $row['categorie'];
                $pacienti_imagine = $row['imagine'];
                $pacienti_id = $row['id'];
                $pacienti_date = $row['date'];
                $pacienti_continut = $row['continut'];
  ...
  <div class="section-6">
    <div class="w-container">
      <div class="articol-sfaturi-blog">
          <a href="pacienti-detaliat.php?pacienti=<?php echo $pacienti_id; ?>" class="link-block-4 w-inline-block">
              <img src="images/pacienti/<?php echo $pacienti_imagine; ?>" alt="">
          </a>

        <div class="div-block-9">
          <h4><?php echo $pacienti_titlu; ?></h4>
          <div class="text-block-39">
              Postat: <span class="text-span-3"><?php echo $pacienti_date; ?></span> -
              Autor: <span class="text-span-2">Recumedis</span> -
              Categoria: <span class="text-span"><?php echo $pacienti_categorie; ?></span>
            </div>

          <div class="text-block-40">

            <p><?php echo strip_tags(substr($pacienti_continut, 0, 3500)) . "..."; ?></p>

          </div>

            <a href="pacienti-detaliat.php?pacienti=<?php echo $pacienti_id; ?>" class="link-5">Mai multe...</a>
          </div>
      </div>
    </div>
  </div>
